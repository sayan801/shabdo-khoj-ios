...
- (void)sw_addUtilityButtonWithColor:(UIColor *)color icon:(UIImage *)icon title:(NSString *)title
{
   ...
   // [button setFrame:CGRectMake(10, 10, 80, 70)];
    ...
    [button setFrame:CGRectMake(0, 0, 80, 70)];
    
    
    UIButton * button1 = [UIButton buttonWithType:UIButtonTypeCustom];
      [button1 setTitle:title forState:UIControlStateNormal];
    button1.titleLabel.textAlignment=NSTextAlignmentCenter;
    [button1.titleLabel setFont:[UIFont fontWithName:@"Helvetica Neue" size:11]];//@"Helvetica Neue"
   
    [button1 setFrame:CGRectMake(5, 66,  68, 3)];//button.frame.size.height + 5)];
...
- (void)sw_addUtilityButtonWithColorreminder:(UIColor *)color icon:(UIImage *)icon title:(NSString *)title
{
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    [button1 setFrame:CGRectMake(10, 66,  68, 3)];//button.frame.size.height + 5)];
